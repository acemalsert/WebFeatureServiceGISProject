...
package Functions;
public class AccordingToNeighbourhood extends AttributeQueryFunctions {

    // class attributes
    private String CQL_FILTER;

    // constructor
    public AccordingToNeighbourhood(String webFeatureServiceURL, String SERVICE, String VERSION, String REQUEST, String TYPENAME, String SRSNAME,String CQL_FILTER) {
